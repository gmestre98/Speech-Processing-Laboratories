...
for dataset in ${DATASET[*]}; do
	...
	while read line; do
		./opensmile-2.3.0/inst/bin/SMILExtract -C opensmile-2.3.0/config/IS11_speaker_state.conf -I $wavDir/$dataset/$line -csvoutput ../part_2/is11_dev.csv
		./opensmile-2.3.0/inst/bin/SMILExtract -C opensmile-2.3.0/config/gemaps/eGeMAPSv01a.conf -I $wavDir/$dataset/$line -csvoutput ../part_2/egemaps_dev.csv
	done < file_list.txt
